...
exprToString (Cube e1 e2 e3)      = (exprToString e1) ++ "*" ++ (exprToString e2)++ "*" ++ (exprToString e3)
...
eval x y (Max e1 e2)                  = max (eval x y e1) (eval x y e2)
eval x y (Cube e1 e2 e3)              = (eval x y e1) * (eval x y e2) * (eval x y e2)
...
build d
  | s == 0        = Sine (build (d-1))
  | s == 1        = Cosine (build (d-1))
  | s == 2        = Average (build (d-1)) (build (d-1))
  | s == 3        = Times (build (d-1)) (build (d-1))
  | s == 4        = Thresh (build (d-1)) (build (d-1)) (build (d-1)) (build (d-1))
  | s == 5        = Max (build (d-1)) (build (d-1))
